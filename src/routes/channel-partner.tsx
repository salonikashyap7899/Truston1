...
const benefits = [
  {
    t: "Industry-Leading Commissions",
    d: "Our tiered structure rewards performance — the more you sell, the more you earn.",
  },
  {
    t: "RERA-Compliant Projects",
    d: "Every TrustOn project is RERA-registered and legally compliant.",
  },
  {
    t: "Dedicated Relationship Manager",
    d: "Your personal point of contact for every query, site visit, and deal update.",
  },
  {
    t: "Co-Marketing & Sales Tools",
    d: "Branded brochures, digital creatives, and co-branded campaigns.",
  },
];
      ...
      <InnerHero
        ...
        title={
          <>
            ...
            <br />
            Earn more,{" "}
            <em className="gradient-bronze-text not-italic font-serif italic">together.</em>
          </>
        }
        ...
        <div className="mx-auto max-w-7xl">
          <Reveal>
            ...
            <h2 className="font-display text-4xl md:text-6xl text-center mb-20">
              What makes TrustOn the{" "}
              <em className="gradient-bronze-text not-italic">best partner?</em>
            </h2>
          </Reveal>
        ...
        <div className="mx-auto max-w-3xl">
          <Reveal>
            ...
            <p className="text-center text-foreground/70 mb-12">
              ...
              Registration is free with no hidden charges — our dedicated relationship manager will
          ...
          <Reveal>
            <form className="bg-cream rounded-md p-10 card-shadow grid sm:grid-cols-2 gap-6">
              ...
              <div className="sm:col-span-2 flex justify-end mt-4">
                <button
                  type="submit"
                  className="rounded-full bg-bronze text-cream px-8 py-4 text-[11px] uppercase tracking-luxe hover:soft-shadow transition-all"
                >
                  Submit Registration →
                </button>
              </div>
...
function Field({ label, type = "text" }: { label: string; type?: string }) {
  return (
    <label className="block">
      ...
      <input
        type={type}
        className="w-full bg-transparent border-b border-border focus:border-bronze outline-none py-3 text-ink"
      />
    </label>
  );
}
